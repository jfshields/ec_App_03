...
var _APIManager = __webpack_require__(91);

var _APIManager2 = _interopRequireDefault(_APIManager);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.APIManager = _APIManager2.default; // index.js
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(23),B=__webpack_require__(7),C=__webpack_require__(6),ba=__webpack_require__(24),da=__webpack_require__(25),ea=__webpack_require__(26),fa=__webpack_require__(27),ia=__webpack_require__(28),D=__webpack_require__(11);
...
var _ClientsList = __webpack_require__(86);

var _ClientsList2 = _interopRequireDefault(_ClientsList);

var _CarersList = __webpack_require__(112);

var _CarersList2 = _interopRequireDefault(_CarersList);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'col-md-8' },
						_react2.default.createElement(_CarersList2.default, null)
					)
				)
			);
		}
...
var ClientsList = function (_Component) {
	...
	function ClientsList() {
		...
		var _this = _possibleConstructorReturn(this, (ClientsList.__proto__ || Object.getPrototypeOf(ClientsList)).call(this));
	...
	_createClass(ClientsList, [{
		...
		value: function componentDidMount() {
			...
			_utils.APIManager.get("/api/client01", function (err, res) {
				if (err) {
					alert('Err1' + err);
					return;
				}
		...
		value: function addClient(client) {
			...
			_utils.APIManager.post("/api/client01", client, function (err, res) {
				if (err) {
					alert('Err2' + err);
					return;
				}
		...
		key: 'deleteClient',
		value: function deleteClient(client_id) {

			_utils.APIManager.get("api/client01/delete/" + client_id, function (err, res) {
				if (err) {
					alert('Err2' + err);
					return;
				}
		...
		value: function render() {
			...
			var listClients = this.state.list.map(function (client, i) {
				return _react2.default.createElement(
					'li',
					{ key: i },
					_react2.default.createElement(_index.ShowClient, { onDelete: _this4.deleteClient.bind(_this4.state.client._id), currentClient: client })
				);
			});
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_index.CreateClient, { onCreate: this.addClient.bind(this) })
				)
			);
		}
	}]);
...
exports.CreateClient = exports.ShowClient = undefined;

var _ShowClient = __webpack_require__(88);

var _ShowClient2 = _interopRequireDefault(_ShowClient);

var _CreateClient = __webpack_require__(90);
...
exports.ShowClient = _ShowClient2.default;
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } //ShowClient.js


var ShowClient = function (_Component) {
	_inherits(ShowClient, _Component);

	function ShowClient() {
		_classCallCheck(this, ShowClient);

		return _possibleConstructorReturn(this, (ShowClient.__proto__ || Object.getPrototypeOf(ShowClient)).call(this));
	}

	_createClass(ShowClient, [{
		key: 'componentDidMount',
		value: function componentDidMount() {
		...
		key: 'render',
		value: function render() {
			var style = _styles2.default.carerbox;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'button',
					{ onClick: this.deleteClient.bind(this), className: 'btn btn-danger' },
					'Delete Client'
				)
			);
		}
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // CreateClient.js
	...
	_createClass(CreateClient, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement("input", { id: "name", onChange: this.updateClient.bind(this), className: "form-control", placeholder: "Client name", type: "text" }),
				_react2.default.createElement("br", null),
				_react2.default.createElement("input", { id: "id", onChange: this.updateClient.bind(this), className: "form-control", placeholder: "Client ID", type: "text" }),
				_react2.default.createElement("br", null),
				_react2.default.createElement(
					"button",
					{ onClick: this.submitClient.bind(this), className: "btn btn-info" },
					"Submit new client"
				)
			);
		}
...
exports.default = {
	...
	delete: function _delete(url, body, callback) {

		_axios2.default.post(url, body).then().catch(function (error) {
			callback(error, null);
		});
	}
}; // APIManager.js
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } //Comment.js


var CarerClient = function (_Component) {
	_inherits(CarerClient, _Component);

	function CarerClient() {
		_classCallCheck(this, CarerClient);

		return _possibleConstructorReturn(this, (CarerClient.__proto__ || Object.getPrototypeOf(CarerClient)).apply(this, arguments));
	}

	_createClass(CarerClient, [{
		key: 'deleteCarer',
		value: function deleteCarer() {
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'span',
					null,
					this.props.currentClient.name_surna
				),
				_react2.default.createElement(
					'span',
					{ style: { marginLeft: 12, marginRight: 12, fontWeight: 200 } },
					' | '
				),
				_react2.default.createElement(
					'span',
					null,
					this.props.currentClient.d_onboard
				),
				_react2.default.createElement('br', null),
				_react2.default.createElement(
					'button',
					{ onClick: this.deleteCarer, style: { margin: 12 }, className: 'btn btn-danger' },
					'Delete Carer'
				)
			);
		}
...
var _CarerClient = __webpack_require__(111);

var _CarerClient2 = _interopRequireDefault(_CarerClient);
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // Comments.js
...
var ClientsList = function (_Component) {
	...
	_createClass(ClientsList, [{
		...
		value: function componentDidMount() {
			...
			_utils.APIManager.get('/api/carer_personal', function (err, response) {
				if (err) {
		...
		value: function submitCarer() {
			...
			_utils.APIManager.post('/api/carer_personal', this.state.carer, function (error, response) {
				if (error) {
		...
		key: 'removeCarer',
		value: function removeCarer() {
			var _this4 = this;

			console.log('Button hit!!!' + JSON.stringify(this.state.carer));
			console.log('Data' + JSON.stringify(this.state.carer._id));

			_utils.APIManager.delete('/api/carer_personal', this.state.carer, function (error, response) {
				if (error) {
					console.log('CH12' + error.message);
				}
		...
		key: 'updateAny',
		value: function updateAny(event) {
			// Update any field
			var updatedClient = Object.assign({}, this.state.carer);
			updatedClient[event.target.id] = event.target.value;
			this.setState({
				carer: updatedClient
			});
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						null,
						'Add a new Carer for client_name'
					),
					_react2.default.createElement('input', { id: 'name_first', onChange: this.updateAny.bind(this), className: 'form-control', type: 'text', placeholder: 'First name' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { id: 'name_surna', onChange: this.updateAny.bind(this), className: 'form-control', type: 'text', placeholder: 'Surname' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { id: 'd_onboard', onChange: this.updateAny.bind(this), className: 'form-control', type: 'date', placeholder: 'Date joined' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { id: 'status', onChange: this.updateAny.bind(this), className: 'form-control', type: 'text', placeholder: 'Status' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'button',
