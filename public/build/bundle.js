...
var _ClientsList = __webpack_require__(35);

var _ClientsList2 = _interopRequireDefault(_ClientsList);

var _CarerClients = __webpack_require__(38);

var _CarerClients2 = _interopRequireDefault(_CarerClients);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'col-md-8' },
						_react2.default.createElement(_CarerClients2.default, null)
					)
				)
			);
		}
...
var _ClientBox = __webpack_require__(36);
...
var ClientsList = function (_Component) {
	...
	function ClientsList() {
		...
		_this.state = {
			...
			list: [{ name: "Alan", number: '1', n_carers: '10' }, { name: "Paul", number: '2', n_carers: '4' }]
		};
		return _this;
	}
		...
		value: function render() {
			var listClients = this.state.list.map(function (client, i) {
				return _react2.default.createElement(
					'li',
					{ key: i },
					_react2.default.createElement(_ClientBox2.default, { currentClient: client })
				);
			});
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('input', { id: 'name', onChange: this.updateAny.bind(this), className: 'form-control', placeholder: 'Client name', type: 'text' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { id: 'number', onChange: this.updateAny.bind(this), className: 'form-control', placeholder: 'Client ID', type: 'text' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'button',
						{ onClick: this.submitClient.bind(this), className: 'btn btn-danger' },
						'Submit new client'
					)
				)
			);
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } //Client.js


var ClientBox = function (_Component) {
	_inherits(ClientBox, _Component);

	function ClientBox() {
		_classCallCheck(this, ClientBox);

		return _possibleConstructorReturn(this, (ClientBox.__proto__ || Object.getPrototypeOf(ClientBox)).apply(this, arguments));
	}

	_createClass(ClientBox, [{
		key: 'render',
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'span',
					{ className: 'detail' },
					this.props.currentClient.number
				),
				_react2.default.createElement('br', null),
				_react2.default.createElement(
					'span',
					null,
					'No. Carers: ',
					this.props.currentClient.n_carers
				)
			);
		}
	}]);
...
var _CarerClient = __webpack_require__(39);
...
var CarerClients = function (_Component) {
	_inherits(CarerClients, _Component);

	function CarerClients() {
		_classCallCheck(this, CarerClients);
	...
	_createClass(CarerClients, [{
		...
		value: function componentDidMount() {
			...
			_axios2.default.get('/api/carer_personal').then(function (response) {
				...
				_this2.setState({ list: response.data.results });
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { id: 'd_onboard', onChange: this.updateAny.bind(this), className: 'form-control', type: 'text', placeholder: 'Date joined' }),
					_react2.default.createElement('br', null),
